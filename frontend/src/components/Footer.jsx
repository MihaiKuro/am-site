    ...
    <footer className="bg-[#0B0F17] text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Brand Column */}
          <div>
            <h3 className="mb-4 font-hero text-xl font-bold text-white">
              Midnight <span className="text-[#F5A623]">Car</span>
            </h3>
            <p className="text-sm text-[#9CA8BC] mb-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li>Email: info@midnightcar.ro</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-[#1A1F2B]">
            ...
            <p className="text-sm text-gray-500 text-center md:text-left">
              © 2026 Midnight Car. Toate drepturile rezervate.
            </p>
